...
Route::get('/remediosof', function () {
    return view('offline/remediosof');
});
Route::get('/ofcabeza', function () {
    return view('offline/ofcabeza');
});
...
Route::view('offline', 'modules.laravelpwa.offline')->name('re');

Route::view('offline/remediosof', 'offline.remediosof')->name('remediosof');

Route::view('offline/ofcabeza', 'offline.ofcabeza')->name('ofcabeza');
Route::view('offline/ofestomago', 'offline.ofestomago')->name('ofestomago');
Route::view('offline/ofgarganta', 'offline.ofgarganta')->name('ofgarganta');
Route::view('offline/ofmareo', 'offline.ofmareo')->name('ofmareo');
Route::view('offline/ofresfriado', 'offline.ofresfriado')->name('ofresfriado');
